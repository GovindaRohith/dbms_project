...
import axios from "./axios";
  ...
  useEffect(() => {
    axios.get("/top_questions") // passing the parameter here
        .then((res) => {
  ...
  <>  
      ...
      <div className="row">
          <div className="col-sm-9">
            <h1 className='ps-5'>Top Questions</h1>
          </div>
        ...
        <div className='col-md-6 mb-3'>
          <h4 className='text-muted ps-5'>{myData.length} Questions</h4>
        </div>
